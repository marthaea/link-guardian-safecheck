...
import { Mail, Github, Building2, Users } from 'lucide-react';
      ...
      <main className="flex-1 py-16">
        <div className="container mx-auto px-4 max-w-4xl">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            {/* Company Info */}
            <div className="bg-gray-800/60 backdrop-blur-sm p-8 rounded-lg shadow-lg border border-cyan-800/30">
              <div className="flex items-center gap-3 mb-6">
                <Building2 className="h-8 w-8 text-cyan-400" />
                <h2 className="text-2xl font-semibold text-cyan-300">Nexus</h2>
              </div>
            ...
            <div className="bg-gray-800/60 backdrop-blur-sm p-8 rounded-lg shadow-lg border border-cyan-800/30">
              ...
              <div className="space-y-6">
                <div className="flex items-center justify-between p-4 bg-gray-900/50 rounded-lg border border-cyan-800/20">
                  <div>
          ...
          {/* Additional Info */}
          <div className="mt-8 bg-gray-800/60 backdrop-blur-sm p-8 rounded-lg shadow-lg border border-cyan-800/30 text-center">
            ...
            <p className="text-cyan-100/90 mb-6">
              ...
              want to report a bug, or have suggestions for improvements, feel free to reach out to our co-founders on GitHub.
            </p>
